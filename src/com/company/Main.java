...
//        System.out.println(maxPath);
        ...
        numberOfVehicles(timeWindows,timeMatrix,nodes,discreteTimeWindows);
...
//                        System.out.println("removed "+j+" "+nodes);
    ...
    public static int[] topologicalSort(ArrayList<ArrayList<Integer>> graph){
        ...
        int[] topologicalSorted = new int[graph.size()-removedcustomers];
        for(int i=0;i<topologicalSorted.length ;i++){topologicalSorted[i] = st.pop();}
        System.out.println("TS :"+Arrays.toString(topologicalSorted));
